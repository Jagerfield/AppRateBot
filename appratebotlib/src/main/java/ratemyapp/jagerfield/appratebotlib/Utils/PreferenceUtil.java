...
public class PreferenceUtil
{
    ...
    public static void setString(Context context, String key, String val) {
        SharedPreferences.Editor e = context.getSharedPreferences(APP_PREFERENCES, context.MODE_PRIVATE).edit();
        e.putString(key, val);
        e.commit();
    }
    ...
    {
        SharedPreferences e = context.getSharedPreferences(APP_PREFERENCES, context.MODE_PRIVATE);
