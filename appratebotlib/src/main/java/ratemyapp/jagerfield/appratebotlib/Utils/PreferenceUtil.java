...
{
    public static final String RATEMYAPP_PREFERENCES = "RATEMYAPP_PREFERENCES";

    public static void setString(Context context, String key, String val) {
        SharedPreferences.Editor e = context.getSharedPreferences(RATEMYAPP_PREFERENCES, context.MODE_PRIVATE).edit();
        e.putString(key, val);
        e.commit();
    }
    ...
    {
        SharedPreferences e = context.getSharedPreferences(RATEMYAPP_PREFERENCES, context.MODE_PRIVATE);
